<template>
  <div class="home">
    ...
    <v-btn
      ...
      rounded
      outlined
      class="orange black--text ma-2"
      >hii</v-btn
    >
    <v-btn fab medium depressed class="orange black--text ma-2">hi</v-btn>
    <v-btn outlined depressed color="red ma-2" dark>12</v-btn>
    <v-btn loading rounded color="pink ma-2" dark>2</v-btn>

    <v-btn depressed class="pink white--text ma-2">
      <v-icon left>mdi-home</v-icon>
      <span>home</span>
    </v-btn>

    <v-btn depressed class="green white--text ma-2">
      <span>Loading</span>
      <v-icon small right>fas fa-circle-notch fa-spin</v-icon>
    </v-btn>

    <v-btn depressed outlined dark color="orange" class=" white--text ma-2">
